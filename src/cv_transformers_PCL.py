...
def subsample_train (dataset, train_subsampler):
  ...
  for line in train_dataloader:
    ...
    if lab==0:
      ...
      downsample_masks.append(masks)
      downsample_labels.append(lab)
    if len(downsample_idx)==positives+3000:
      print(f'the downsampled dataset has now {positives} positive examples and 3000 negative examples of PCL')
      break
