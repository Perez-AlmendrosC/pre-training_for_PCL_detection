...
from transformers import RobertaTokenizer, RobertaForSequenceClassification, AutoModelForSequenceClassification, AdamW, AutoTokenizer, AutoModelWithHeads, RobertaTokenizerFast, AutoConfig
...
def test_predictions(finetuned_model, test_dataloader, fold_counter):
  ...
  with open(os.path.join('results',f'results_ftmodel={args.model_name}_rec_binary.txt'), 'a')as outf:
